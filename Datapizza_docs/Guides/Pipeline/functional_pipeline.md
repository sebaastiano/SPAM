...
Source: http://docs.datapizza.ai/0.0.9/Guides/Pipeline/functional_pipeline/
...
Defines how data flows between [Nodes](http://docs.datapizza.ai/0.0.9/API%20Reference/Type/node/):
...
This pipeline:
1. [Rewrites/processes](http://docs.datapizza.ai/0.0.9/API%20Reference/Modules/rewriters/) the user query
2. [Creates embeddings](http://docs.datapizza.ai/0.0.9/API%20Reference/Embedders/chunk_embedder/) from the processed query
3. Retrieves relevant chunks from a [vector database](http://docs.datapizza.ai/0.0.9/API%20Reference/Vectorstore/qdrant_vectorstore/)
4. [Creates a prompt template](http://docs.datapizza.ai/0.0.9/API%20Reference/Modules/Prompt/ChatPromptTemplate/) with the retrieved context
